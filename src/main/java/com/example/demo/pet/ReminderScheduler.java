...
public class ReminderScheduler {
    ...
    private boolean sendWechatMessage(Reminder reminder) throws Exception {
        ...
        String locationValue = reminder.getLocation() != null && !reminder.getLocation().isEmpty() ? reminder.getLocation() : "无";
        ...
        String notesValue = reminder.getNotes() != null && !reminder.getNotes().isEmpty() ? reminder.getNotes() : "无";
